import { buildExplanationText, buildNextMoveText, inferConfidenceLevel } from './copy.ts';
import { extractSemanticFacts, findSemanticScenarioOverride } from './facts.ts';
import { clampNumber, buildHaystack } from './normalize.ts';
import { matchSignal } from './patterns.ts';
import { assessCaseInputQuality, type CaseInputQualityReason } from '../caseInputQuality.ts';
import { assessCaseSafety, CaseSafetyRoutingError } from '../caseSafety.ts';
import type {
  CaseAnalysisInput,
  CaseAnalysisResult,
  Category,
